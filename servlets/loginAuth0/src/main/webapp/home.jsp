        ...
        <div class="container">
            <div class="mt-5">
                <div class="text-center hero my-5">
                    <img src="${pageContext.request.contextPath}/img/java-ee.png" alt="Java EE logo" width="120"/>
                    <h1 class="mb-4">Java EE Sample Project</h1>
                    <p class="lead">
                        This is a sample application that demonstrates an authentication flow for a web application using Java EE.
                    </p>
                </div>
